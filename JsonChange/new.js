 ...
 */
     ...
     colsEventCoreExtra_Columns_new = [{
            displayName: 'Id',
            field: 'event_id',
            frName: '',
            engName: 'Id ',
     ...
     colsTackleExtraFromSeqCore_Columns_new = [{
            displayName: 'Id',
            field: 'event_id',
            frName: '',
            engName: 'Id',
    ...
    // var colThrowInExtra same as passExtra
     colsHeaderExtraFromSeqCore_Columns_new = [{
            displayName: 'Id',
            field: 'event_id',
            frName: '',
            engName: 'Id',
