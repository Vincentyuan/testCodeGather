...
function : getcolumnsdef
		var allColumnsDef = {};
		var colsSeqCore = in file  // 1,7,8,4,3,5,2,6
		var colsSeqExtra = in file // 1
		var colsEventCoreExtra = in file //4,3,5,2,6
		...
		var colsAllEvents = in file 
	{
		...
		allColumnsDef[eLiveSubWinType.events] = colsAllEvents;
